import { GraphQLEntityField, GraphQLJsonFieldType, GraphQLEntityIndex, ProjectManifestVersioned } from '@subql/common';
import ejs from 'ejs';
...
export declare function generateDatasourceTemplates(projectPath: string, projectManifest: ProjectManifestVersioned): Promise<void>;
